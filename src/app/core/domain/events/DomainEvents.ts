...
export class DomainEvents<T> {
  ...
  public static dispatch<T>
    ...
    switch (option) {
      case ActionEvents.BehaviorSubject: {
        aggregate.domainBS = this.globalBS[aggregate.id].behaviourSubject;
      ...
      case ActionEvents.Observable: {
        ...
        return this.globalBS[aggregate.id][ActionEvents.Observable];
      }
      default: {
  ...
  private static findAggregateByID(id: string): AggregateRoot<any> | null {
